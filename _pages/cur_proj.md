...
Figure caption: Catches by country (inset) from FAO landings reports and the location of snow crab populations (map).
...
![figure2](https://szuwalski.github.io/files/ebs_crab_map.png)

Figure caption: Spatial distribution of crab populations in the Bering Sea (left), catch of from each population (top right) and associated ex-vessel value (bottom right).